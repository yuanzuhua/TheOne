...
namespace TheOne.Redis {
    ...
    public static class Commands {
        ...
        public static readonly byte[] Monitor = "MONITOR".ToUtf8Bytes();
        public static readonly byte[] Debug = "DEBUG".ToUtf8Bytes();
        public static readonly byte[] Config = "CONFIG".ToUtf8Bytes();
        ...
        public static byte[] GetUnit(string unit) {
            ...
            switch (unit) {
                ...
                case RedisGeoUnit.Feet:
                    return Feet;
                default:
                    throw new NotSupportedException(string.Format("Unit '{0}' is not a valid unit", unit));
            }
        }
