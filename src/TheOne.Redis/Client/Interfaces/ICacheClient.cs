...
namespace TheOne.Redis.Client {
    ...
    public interface ICacheClient : IDisposable {
        ...
        /// </returns>
        /// <remarks>
        ///     The item must be inserted into the cache before it can be changed. The item must be inserted as a <see cref="T:System.String" />.
        ///     The operation only works with <see cref="System.UInt32" /> values, so -1 always indicates that the item was not found.
        /// </remarks>
